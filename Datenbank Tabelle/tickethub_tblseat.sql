...
CREATE TABLE `tblseat` (
  `pkSeat` int NOT NULL AUTO_INCREMENT,
  `fkEvent` int NOT NULL,
  `Reihe` varchar(10) DEFAULT NULL,
  `SeatNumber` varchar(10) DEFAULT NULL,
  `Kategorie` varchar(50) DEFAULT NULL,
  `Status` varchar(50) DEFAULT 'frei',
  PRIMARY KEY (`pkSeat`),
  KEY `fkEvent` (`fkEvent`),
  CONSTRAINT `tblseat_ibfk_1` FOREIGN KEY (`fkEvent`) REFERENCES `tblevent` (`pkEvent`) ON DELETE CASCADE
